...
\lecturenumber{5}
\lecturetitle{Uninformed Search}
\lecturedate{}
...
\begin{frame}[shrink=20]{When Reflex Behavior Is Not Enough}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.38in]{search-reasons-about-futures.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Newell and Simon: Reasoning as Search}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \lectureimage[2.50in]{logic-theorist-problem-space.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{A Solution Is a Sequence of Actions}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.20in]{solution-action-sequence.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Why Generate States On Demand?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.40in]{generate-search-space-on-demand.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Parent Pointers Turn a Goal into a Plan}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.35in]{parent-pointers-reconstruct-path.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Breadth-First Search Expands by Depth}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.45in]{bfs-level-order.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Depth-First Search Commits to One Branch}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.45in]{dfs-deep-branch-backtrack.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Search Is a Form of Internal Simulation}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      % Search direction: agent internally branching through hypothetical futures before choosing one action.
      \lectureimage[2.42in]{search-inside-intelligent-agent.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Application: The Micromouse Competition}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.48in]{micromouse-competition-overview.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Abstract the Robot into a Search Problem}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.41\textwidth}
      ...
      \lectureimage[2.42in]{micromouse-discrete-search-abstraction.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Wall Following Is Primarily Reactive}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.40in]{micromouse-wall-following-reactive.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Micromouse as Depth-First Search}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      % Search direction: maze/tree showing a deep DFS route and an unvisited shorter alternative.
      \lectureimage[2.42in]{micromouse-dfs-misses-shortcut.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Flood Fill: A Practical Micromouse Strategy}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      % Search direction: grid with center goal value 0 and increasing flood-fill distance labels outward.
      \lectureimage[2.45in]{micromouse-flood-fill-distance-map.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Micromouse Is More Than ``Run BFS on a Graph''}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.32in]{micromouse-agent-loop.png}
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=20]{Image Placeholder Index}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.49\textwidth}
      \begin{itemize}
        \item \texttt{search-reasons-about-futures.png}
        \item \texttt{logic-theorist-problem-space.png}
        \item \texttt{solution-action-sequence.png}
        \item \texttt{generate-search-space-on-demand.png}
        \item \texttt{parent-pointers-reconstruct-path.png}
        \item \texttt{bfs-level-order.png}
        \item \texttt{dfs-deep-branch-backtrack.png}
        \item \texttt{search-inside-intelligent-agent.png}
      \end{itemize}
    \end{column}

    \begin{column}{0.49\textwidth}
      \begin{itemize}
        \item \texttt{micromouse-competition-overview.png}
        \item \texttt{micromouse-discrete-search-abstraction.png}
        \item \texttt{micromouse-wall-following-reactive.png}
        \item \texttt{micromouse-dfs-misses-shortcut.png}
        \item \texttt{micromouse-flood-fill-distance-map.png}
        \item \texttt{micromouse-agent-loop.png}
      \end{itemize}
    \end{column}
  \end{columns}
