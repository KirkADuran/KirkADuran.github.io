...
\newcommand{\lectureimage}[2][2.05in]{\includegraphics[width=\linewidth,height=#1,keepaspectratio]{#2}}
...
\begin{frame}{Is This Intelligence?}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.58\textwidth}
      \lectureimage[2.25in]{slide9.jpg}
    \end{column}
...
\begin{frame}{Is This Intelligent?}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.42\textwidth}
      \lectureimage[2.25in]{slide10.jpeg}
    \end{column}
...
\begin{frame}[shrink=10]{Simple Reflex Agents: Strengths And Weaknesses}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
  ...
  \vspace{0.02in}
  \begin{center}
    \includegraphics[width=0.52\linewidth,height=1.1in,keepaspectratio]{slide12.png}
  \end{center}
\end{frame}
...
\begin{frame}[shrink=30]{Simple Reflex Example: Thermostat}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.4\textwidth}
      \lectureimage[2.0in]{slide13.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=35]{Historical Reflex Example: Jacquard Loom}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      \lectureimage[2.0in]{slide14.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Model-Based Reflex Example: Self-Driving Car}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.46\textwidth}
      \lectureimage[2.05in]{slide17.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Reflex Or Model-Based Reflex?}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.58\textwidth}
      \lectureimage[2.25in]{slide18.jpeg}
    \end{column}
    \begin{column}{0.36\textwidth}
      \begin{activity}
...
\begin{frame}{Goal-Based Architecture}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.55\textwidth}
      \lectureimage[2.25in]{slide 21.png}
    \end{column}
    \begin{column}{0.39\textwidth}
      \begin{itemize}
...
\begin{frame}{Goal-Based Example: Vacuum Robot}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.45\textwidth}
      \lectureimage[2.25in]{slide22.jpg}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
...
\begin{frame}[shrink=10]{Is A Goal Enough?}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.42\textwidth}
      \lectureimage[2.25in]{slide23.png}
    \end{column}
    \begin{column}{0.52\textwidth}
      \begin{activity}
...
\begin{frame}{Utility-Based Agent}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.46\textwidth}
      \lectureimage[2.05in]{slide25.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Goals Or Utility Are Not Enough}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.56\textwidth}
      \lectureimage[2.25in]{slide27.jpeg}
    \end{column}
...
\begin{frame}[shrink=10]{Learning Agents}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.52\textwidth}
      \begin{cpdefinition}
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \lectureimage[1.75in]{slide29.jpg}
      \vspace{0.03in}
      \begin{keyidea}
...
\begin{frame}[shrink=20]{Problem Abstraction}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.43\textwidth}
      \lectureimage[2.05in]{slide33.jpeg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Chess As A Single-State Problem}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.43\textwidth}
      \lectureimage[2.25in]{slide37.png}
    \end{column}
    \begin{column}{0.51\textwidth}
      \begin{itemize}
...
\begin{frame}[shrink=30]{Belief States}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \lectureimage[2.05in]{slide39.jpeg}
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{cpdefinition}
...
\begin{frame}[shrink=10]{Exploration Example: Self-Driving Car}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.46\textwidth}
      \lectureimage[2.05in]{slide42.jpeg}
    \end{column}
  \end{columns}
\end{frame}
