...
\begin{frame}{Self-Driving Cars}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      \imageplaceholder{self-driving-car.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Vacuum Bot}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \imageplaceholder{vacuum-bot.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{AI Agent: Comparing Intelligence}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      \imageplaceholder{agent-comparison.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Ada Lovelace's Argument (1843)}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.33\textwidth}
      \imageplaceholder{ada-lovelace.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=35]{Are Computers Intelligent?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      \imageplaceholder{biological-computer.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Agent: A First Intuition}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      \imageplaceholder{agent-loop.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Agent Function: The Abstract Model}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.40\textwidth}
      \imageplaceholder{agent-function-diagram.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=35]{Vacuum Cleaner Agent Function}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.43\textwidth}
      \imageplaceholder{agent-function-table.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=35]{Agent Program: The Concrete Implementation}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.40\textwidth}
      \imageplaceholder{agent-program-visual.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Aristotle's Practical Reasoning}
  ...
  \vspace{0.08in}
  \begin{center}
    \imageplaceholder{aristotle-practical.jpg}
  \end{center}
\end{frame}
...
\begin{frame}[shrink=10]{Vacuum Bot: Is It Rational?}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.56\textwidth}
      \imageplaceholder{vacuum-rationality.jpg}
    \end{column}
    \begin{column}{0.38\textwidth}
      \begin{activity}
...
\begin{frame}{Rationality Versus Omniscience}
  ...
  \vspace{0.08in}
  \begin{center}
    \imageplaceholder{rationality-omniscience-1.jpg}
  \end{center}
\end{frame}
...
\begin{frame}[shrink=10]{Rationality Is Not Perfection}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \imageplaceholder{rationality-omniscience-2.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Not Learning: The Danger Of Rigid Behavior}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.36\textwidth}
      \imageplaceholder{rigid-robot.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Learning: Rational Agents Modify Future Percepts}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \imageplaceholder{learning-loop.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=15]{Exploration In Unknown Environments}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \imageplaceholder{learning-exploration.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Alan Turing On Learning (1950)}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.35\textwidth}
      \imageplaceholder{turing-chappie.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Autonomy}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.38\textwidth}
      \imageplaceholder{autonomy-concept.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=15]{Autonomy: Prior Knowledge And Learning}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.39\textwidth}
      \imageplaceholder{autonomy-comparison.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{The Problem Agents Must Solve}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.42\textwidth}
      \imageplaceholder{peas-taxi.jpg}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{PEAS Examples}
  ...
  \vspace{0.08in}
  \begin{center}
    \imageplaceholder{peas-examples.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Observability: How Much Can The Agent See?}
  ...
  \vspace{0.08in}
  \begin{center}
    \imageplaceholder{observability.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Deterministic Versus Stochastic}
  ...
  \vspace{0.10in}
  \begin{center}
    \imageplaceholder{deterministic-stochastic.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Episodic Versus Sequential}
  ...
  \vspace{0.10in}
  \begin{center}
    \imageplaceholder{episodic-sequential.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Static Versus Dynamic}
  ...
  \vspace{0.10in}
  \begin{center}
    \imageplaceholder{static-dynamic.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Discrete Versus Continuous}
  ...
  \vspace{0.10in}
  \begin{center}
    \imageplaceholder{discrete-continuous.jpg}
  \end{center}
\end{frame}
...
\begin{frame}{Known Versus Unknown}
  ...
  \vspace{0.10in}
  \begin{center}
    \imageplaceholder{known-unknown.jpg}
  \end{center}
\end{frame}
...
% ============================================================
\sectionframe{Part 7: Course Reminder}
% ============================================================
