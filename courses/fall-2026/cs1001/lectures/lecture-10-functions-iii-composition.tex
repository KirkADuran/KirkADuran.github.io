...
\begin{frame}{One Function Can Call Another Function}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.75in]{nested-call-overview.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Returning Unwinds One Call at a Time}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.43\textwidth}
      ...
      \lectureimage[2.65in]{call-stack-unwind.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{The Same Spelling Can Refer to Different Bindings}
...
\begin{frame}{Trace the Data Before Tracing the Implementation}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.85in]{magnitude-data-flow.png}
    \end{column}
  \end{columns}
\end{frame}
