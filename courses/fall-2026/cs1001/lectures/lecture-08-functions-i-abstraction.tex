...
\begin{frame}{Start with the Data}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.55in]{data-first-model.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Scaling Repetition Is a Design Problem}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \lectureimage[2.65in]{many-cubes-one-rule.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{A Function Is a Named, Parameterized Computation}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.70in]{function-abstraction.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{A Function Call Applies the Abstraction to Concrete Data}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \lectureimage[2.42in]{definition-versus-call.png}
    \end{column}
  \end{columns}
...
\begin{frame}{A Simple Call Extends the Data-Flow Model}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.75in]{simple-call-data-flow.png}
    \end{column}
  \end{columns}
\end{frame}
