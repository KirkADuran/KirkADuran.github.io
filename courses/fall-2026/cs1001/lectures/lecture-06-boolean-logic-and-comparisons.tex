...
\begin{frame}{Boolean Logic Begins with Claims}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.25in]{slide4.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Boolean Values Can Be Stored in Variables}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.25in]{slide6.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Parentheses Make Logical Structure Explicit}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \lectureimage[2.25in]{slide40.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{George Boole and the Origins of Boolean Algebra}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.38\textwidth}
      ...
      \lectureimage[2.75in]{slide53.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=8]{Boolean Logic in the CPU}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.54\textwidth}
      \begin{itemize}
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.20in]{cpu-boolean-logic-gates.png}
    \end{column}
  \end{columns}
\end{frame}
