...
\begin{frame}{What Are Computers?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      \lectureimage[2.1in]{computer-components.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{Why Do We Use Computers?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.41\textwidth}
      \lectureimage[1.55in]{clerical-computation.png}
      \vspace{0.05in}
      \begin{keyidea}
...
\begin{frame}{From Counting Tools to Algorithms}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \end{block}
      \lectureimage[1.55in]{abacus.png}
    \end{column}
    \begin{column}{0.48\textwidth}
      ...
      \end{block}
      \lectureimage[1.55in]{al-khwarizmi.png}
    \end{column}
  \end{columns}
  \vspace{0.08in}
  \begin{keyidea}
...
\begin{frame}{Mechanical Calculation and Programmable Machines}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.47\textwidth}
      ...
      \end{block}
      \lectureimage[1.55in]{mechanical-calculator.png}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{1830s}
      ...
      \end{block}
      \lectureimage[1.55in]{babbage-engine.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=35]{1936: Turing's Abstract Computer}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.41\textwidth}
      \lectureimage[2.1in]{turing-machine.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{1970s--1990s: Computers Become Personal and Connected}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.47\textwidth}
      ...
      \end{block}
      \lectureimage[1.75in]{early-personal-computer.png}
    \end{column}
    \begin{column}{0.47\textwidth}
      ...
      \end{block}
      \lectureimage[1.75in]{internet-network-map.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{The Stored-Program Computer}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \lectureimage[2.1in]{stored-program-architecture.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=20]{Inside the CPU: Control, Arithmetic, and Registers}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      \lectureimage[2.0in]{computer-components.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{The Instruction Cycle: Fetch, Decode, Execute}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.49\textwidth}
      \lectureimage[2.1in]{instruction-cycle.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{Do Computers ``Think''?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      \lectureimage[2.0in]{water-computer.png}
      \begin{center}
...
\begin{frame}{Computer Memory: Locations and Addresses}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.46\textwidth}
      \lectureimage[2.0in]{memory-address.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{Bits and Bytes Are Physical}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.43\textwidth}
      \lectureimage[2.0in]{memory-bits.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{Memory Scale and Memory Technology}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.47\textwidth}
      \lectureimage[1.35in]{memory-core.png}
...
\begin{frame}{Why Binary?}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.43\textwidth}
      \lectureimage[2.0in]{transistor.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Reading Binary Numbers}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.37\textwidth}
      \lectureimage[2.0in]{binary-conversion.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Binary Addition Works Like Familiar Addition}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.49\textwidth}
      \lectureimage[2.0in]{binary-addition.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Machine Language: Instructions the Processor Executes}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.41\textwidth}
      \lectureimage[2.0in]{machine-code.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Assembly Language Gives Machine Instructions Names}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.44\textwidth}
      \lectureimage[2.0in]{assembly-code.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=25]{Higher-Level Languages Automate the Translation Work}
  \begin{columns}[T,onlytextwidth]
    ...
    \end{column}
    \begin{column}{0.43\textwidth}
      \lectureimage[2.0in]{compiler.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=10]{Why Learn to Code When Tools Can Generate Code?}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      \lectureimage[2.0in]{highlevel-language.png}
    \end{column}
  \end{columns}
\end{frame}
