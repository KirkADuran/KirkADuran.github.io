...
% ../assets/lecture-04/ to replace the placeholder automatically.
...
\begin{frame}{A Group of Bits Does Not Explain Its Own Meaning}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.22in]{bits-require-interpretation.png}
...
\begin{frame}{Different Kinds of Values Need Different Interpretations}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \lectureimage[2.18in]{fundamental-value-categories.png}
...
\begin{frame}{Representations Introduce Costs and Limits}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.41\textwidth}
      ...
      \lectureimage[2.18in]{fixed-versus-variable-size-data.png}
...
\begin{frame}{A Ten-Character Limit Shaped Feraligatr's Name}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.45\textwidth}
      ...
      \lectureimage[2.22in]{feraligatr-ten-character-limit.png}
...
\begin{frame}{Python Integers Grow as More Digits Are Required}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.22in]{python-integer-growing-representation.png}
...
\begin{frame}{The Point ``Floats'' by Changing the Scale}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \lectureimage[2.25in]{floating-point-sign-significand-exponent.png}
...
\begin{frame}{A Large Range Does Not Guarantee Exact Representation}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.18in]{floating-point-decimal-approximation.png}
...
\begin{frame}{Boolean Values Represent Two Possibilities}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.48\textwidth}
      ...
      % Search direction: restrained two-state True and False visual without logic operators.
      \lectureimage[1.05in]{boolean-two-literal-values.png}
...
\begin{frame}{Operand Types Select the Applicable Operator Rule}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.45\textwidth}
      ...
      \lectureimage[2.12in]{operator-type-dispatch.png}
...
\begin{frame}{The Same \texttt{+} Symbol Can Mean Different Operations}
  ...
  % Search direction: plus operator branching to numeric addition and string concatenation.
  \lectureimage[1.30in]{plus-number-versus-string.png}
...
\begin{frame}{Strings Support Concatenation and Repetition}
  ...
  % Search direction: text fragments joining and a text fragment repeating three times.
  \lectureimage[1.25in]{string-concatenation-and-repetition.png}
...
\begin{frame}{Unsupported Type Combinations Produce a \texttt{TypeError}}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.46\textwidth}
      ...
      % Search direction: incompatible number and text operands blocked before an operator.
      \lectureimage[2.12in]{incompatible-operands-type-error.png}
...
\begin{frame}{Explicit Conversion Requests a New Type}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.46\textwidth}
      ...
      \lectureimage[2.18in]{explicit-conversion-new-value.png}
...
\begin{frame}{Use Colab to Inspect Both the Value and Its Type}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.47\textwidth}
      ...
      % Search direction: paired Colab cells evaluating 7 + 2.0 and type(7 + 2.0).
      \lectureimage[2.23in]{colab-value-and-type-inspection.png}
