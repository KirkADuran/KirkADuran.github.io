...
\begin{frame}[shrink=8]{Execution Has an Order}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.39\textwidth}
      ...
      \lectureimage[2.55in]{execution-top-to-bottom.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[shrink=8]{A Trace Table Separates Time, State, and Output}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.45in]{trace-table-anatomy.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Reassignment Replaces a Variable's Current Association}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.35in]{reassignment-overwrites-current-state.png}
    \end{column}
  \end{columns}
\end{frame}
