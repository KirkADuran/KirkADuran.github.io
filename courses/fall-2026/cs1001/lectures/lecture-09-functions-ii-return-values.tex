...
\begin{frame}{Expressions Produce Values}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \lectureimage[2.65in]{call-is-expression.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{A Call Temporarily Changes the Flow of Execution}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.55in]{call-control-flow.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Returning Reconnects the Function with Its Caller}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.41\textwidth}
      ...
      \lectureimage[2.55in]{return-to-caller.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Each Call Has a Local Execution Environment}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.55in]{local-execution-environment.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Manual Prediction Comes Before the Debugger}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.40\textwidth}
      ...
      \lectureimage[2.55in]{predict-trace-debug-compare.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Worked Trace: Reason from Values, Not Similar Names}
  \begin{block}{Program}
    \texttt{def difference(first: int, second: int) -> int:}\\
